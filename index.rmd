...
documentclass: book
link-citations: yes
github-repo: msaby/formation_openrefine_2017_09_28
url: 'https://msaby.github.io/formation_openrefine_2017_09_28/'
...
* Auteur : Mathieu Saby, BU de l'Université Nice Sophia-Antipolis (<a href="mailto:mathieu(dot)saby(at)unice(dot)com">nom.prenom@unice.fr</a>)
...
* **[Matinée: introduction](#p1)**
    * Présentation d'Openrefine
    * Transformations simples
    * Utilisation de l'interface graphique
    * Introduction au langage GREL

* **[Après-midi: approfondissement](#p2)**
    * Aller plus loin avec GREL
    * Transformations avancées
    * Scraping
    * Alignement de vocabulaires
    * Utilisation de Jython
